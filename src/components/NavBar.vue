<!-- 
 <nav>
    <div class="nav-wrapper green lighten-3">
      <a href="#" class="brand-logo"> Remember my Dogs!!</a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><router-link :to="{name: 'Pet'}">
          <i class="mdi mdi-36px mdi-dog"></i></router-link></li>
        <li><router-link :to="{name: 'Owner'}">
          <i class="mdi mdi-36px mdi-face"></i></router-link></li>
        <li><router-link :to="{name: 'Medical'}">
          <i class="mdi mdi-36px mdi-briefcase-plus"></i>
        </router-link></li>
      </ul>
    </div>
  </nav>
...
<template>
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Remember my Dogs!!</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                <a class="flex items-center px-4 py-2 text-gray-700 bg-gray-200 rounded-md dark:bg-gray-700 dark:text-gray-200" href="#">
                    ...
                    <i class="mdi mdi-36px mdi-dog"></i>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <i class="mdi mdi-36px mdi-face"></i>
                    <router-link :to="{name: 'Owner'}">
                        <span class="mx-4 font-medium">Tutores</span>
                    </router-link>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <router-link :to="{name: 'Medical'}">
                        <span class="mx-4 font-medium">Veterinários</span>
                    </router-link>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <i class="mdi mdi-36px mdi-dog"></i>
                    <router-link :to="{name: 'Pet'}">
                    <span class="mx-4 font-medium">Pets</span>
                    </router-link>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <span class="mx-4 font-medium">Administração</span>
                </a>
